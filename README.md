...
- ScriptableObject configuration for flexible setup with default profiles for different environments (development, QA, production)
...
- Exception cause logging with type and message
- Quick presets (Verbose, Normal, Production) for one-click configuration
- Advanced formatting options: customizable timestamp format and message prefix
...
2. Assign categories and minimum log level in the inspector, or use presets for quick setup. Optionally, configure timestamp format and message prefix under Advanced Settings.
